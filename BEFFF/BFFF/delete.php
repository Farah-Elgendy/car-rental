			...
			<form action="delete.php" method="post">
				...
				<div style="background:lightgrey;opacity:90%; " >
					...
					<div style="margin-left:60%">
						<button style="color:white;background-color:red;border: none;font-size:20;margin-left:30%" class="btn btn-primary btn-lg" name= "delete_car"> DELETE Car! </button><br></br>
					</div>
